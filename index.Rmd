...
**Data from the CDC:**  
**BRFSS:** Asthma information was collected from [BRFSS](https://www.cdc.gov/brfss/), the CDC's Behavioral Risk Factor Surveillance System. We collected state and metropolitan area-level data from the BRFSS for years 2013-2020  
...
More details regarding the data sources and our use of the datasets can be found [here](report.html#data).
...
5. Based on the Spearman correlation estimates overall for the period from 2013 to 2020, there does not appear to be a monotonic relationship between median AQI and asthma prevalence. The correlation test results were not statistically significant at the 5% level of significance. 
